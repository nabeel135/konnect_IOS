...
class map: UIView {
    ...
    func Create(islogedin:Bool,any:Any,signinBtn:Selector,createAccountBtn:Selector,forgotpassBtn:Selector,withinview:UIView) {
        ...
        if islogedin == false {
            ...
            myAccountpop.signInbtn.Label(x: 0, y: 40, width: x, height: 40, txt: "Sign In", fontsize: 12, bold: false, cornerRadius: 0, border: 0, borderColor: .clear, alignment: .center, bkcolor: .clear, txtcolor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), view: myAccountpop.obj.view)
